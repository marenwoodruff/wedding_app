...
class HotelsControllerTest < ActionController::TestCase
  ...
  test "should create hotel" do
    assert_difference('Hotel.count') do
      post :create, hotel: { city: @hotel.city, name: @hotel.name, nights: @hotel.nights, sharing_with: @hotel.sharing_with }
    end
  ...
  test "should update hotel" do
    patch :update, id: @hotel, hotel: { city: @hotel.city, name: @hotel.name, nights: @hotel.nights, sharing_with: @hotel.sharing_with }
    assert_redirected_to hotel_path(assigns(:hotel))
  end
